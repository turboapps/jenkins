...
public class SnapshotBuilder extends BaseBuilder {
    ...
    public InstallScriptSettings getInstallScriptSettings() {
        return installScriptSettings;
    }

    public StartupFileSettings getStartupFileSettings() {
        return startupFileSettings;
    }

    public String getPreInstallScriptPath() {
        return preInstallScriptPath;
    }

    public String getPostSnapshotScriptPath() {
        return postSnapshotScriptPath;
    }
